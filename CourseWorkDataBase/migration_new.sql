...
CREATE TABLE "Appointments" (
    ...
    CONSTRAINT "FK_Appointments_Statuses_StatusId" FOREIGN KEY ("StatusId") REFERENCES "Statuses" ("Id") ON DELETE RESTRICT
);
...
VALUES ('20241218144310_new', '9.0.0-rc.2.24474.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241218144329_firstTrigger', '9.0.0-rc.2.24474.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241218144359_secondTrigger', '9.0.0-rc.2.24474.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20241218144432_thirdTrigger', '9.0.0-rc.2.24474.1');
